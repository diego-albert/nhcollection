...
<?php get_header(); ?>
  ...
  data-component="youtube-player-component"
  >
    ...
    <div class="player-sleep"> <!-- Player Inactive -->
      ...
      <div class="player-info-content">
        ...
        <button class="block-button play-button play-video-js" data-yt-id="816fJW8oFvs"><span class="icon icon-play_icon"></span></button>
      </div>
    </div>
